...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of com.awareframework.ios.sensor.rotation.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/tetujin/com.awareframework.ios.sensor.rotation'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'tetujin' => 'tetujin@ht.sfc.keio.ac.jp' }
  s.source           = { :git => 'https://github.com/tetujin/com.awareframework.ios.sensor.rotation.git', :tag => s.version.to_s }
